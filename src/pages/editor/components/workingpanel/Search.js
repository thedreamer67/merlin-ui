			...
			<div className='innerSearchContainer'>
				...
				<div className='HeatmapContainer'>
					<div className='videoSearch'>
						<SearchVideo currentFrame={currentFrame} maxFrames={maxFrames} setcurrentFrame={setcurrentFrame} sliderPosition={sliderPosition} setSliderPosition={setSliderPosition} SearchVideoSeeking={SearchVideoSeeking} setSearchVideoSeeking={setSearchVideoSeeking}/>
					</div>
					<img className='demoHeatmap' src={demoHeatmap}></img>
					<Slider id='searchscroll' className='searchscroll' maxFrames={maxFrames} setSearchVideoSeeking={setSearchVideoSeeking} currentFrame={currentFrame} setcurrentFrame={setcurrentFrame} sliderPosition={sliderPosition} setSliderPosition={setSliderPosition}/>
				</div>
			</div>
			<div className='TableContainer'>
				<Table setSliderPosition={setSliderPosition} setSearchVideoSeeking={setSearchVideoSeeking} maxFrames={maxFrames}/>
			</div>
		</div>
	)
};
...
function SearchVideo(props){
	...
	const [currentSearchVideoPlaybackTime, setCurrentSearchVideoPlaybackTime] = useState(0);
	...
	useEffect(() => {
		if (SearchVideoSeeking) {
			...
			setCurrentSearchVideoPlaybackTime(sliderPosition * SearchVideoRef.current.getDuration());
