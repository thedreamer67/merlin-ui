        ...
        <div className='magicActionContainer'>
            <div className='toolbox'>    
                <div onClick={handlePaintClick} style={{backgroundColor: paintclick ? 'purple' : 'transparent'}}>
                    <Tooltip title="Use this to click on an object to select" placement="left-end">
                ...
                <div onClick={handleEraserClick} style={{backgroundColor: eraserclick ? 'purple' : 'transparent'}}>
                    <Tooltip title="Use this to click on an object to unselect" placement="left-end">
                        <div className="toolContainer">
                ...
                <div onClick={handleTrashClick} style={{backgroundColor: trashclick ? 'purple' : 'transparent'}}>
                    <Tooltip title="Use this to unselect all objects" placement="left-end">
                        <div className="toolContainer">
...
function MaskImage(props) {
    ...
    return (
        <div className='imageContainer'>
            {imgclick ? null : <img className='maskCanvas' onClick={handleImgClick} src={newSRC}></img> }
